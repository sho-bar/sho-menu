...
/***/ "./resources/admin/ts/modules/DishSearchDropdown.ts":
/*!**********************************************************!*\
  !*** ./resources/admin/ts/modules/DishSearchDropdown.ts ***!
  \**********************************************************/
...
var DishSearchDropdown = function () {
  ...
  DishSearchDropdown.prototype.fetchMatchingDishes = function (inpValue) {
    var _this = this;
    this.loading(true);
    var url = '/wp-json/wp/v2/search' + "?subtype=sho-menu-dishes" + "&search=".concat(inpValue);
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url).then(function (resp) {
      _this.loading(false);
      _this.renderDishes(resp.data);
    })["catch"](function (err) {
      _this.loading(false);
      console.error(err);
    });
  };
  DishSearchDropdown.prototype.renderDishes = function (dishes) {
  ...
  DishSearchDropdown.prototype.deleteDish = function (e) {
    var target = e.target;
    var dishId = target.dataset.dishId;
    if (!dishId) {
  ...
  DishSearchDropdown.prototype.addDeleteListenerForExistingDishes = function () {
    var _this = this;
    var selector = '#sho-recommended-dishes-list .has-been-saved button';
    var buttons = this.list.querySelectorAll(selector);
    buttons.forEach(function (btn) {
      return btn.addEventListener('click', _this.deleteDish);
    });
  };
  return DishSearchDropdown;
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DishSearchDropdown);
...
/*!************************************!*\
  ...
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _admin_modules_DishSearchDropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @admin/modules/DishSearchDropdown */ "./resources/admin/ts/modules/DishSearchDropdown.ts");
